...
import com.ikservices.oficinamecanica.workorders.payments.infra.dto.UpdatePaymentsDTO;
...
public class PaymentController {
	...
	@Transactional
	@PutMapping
	public ResponseEntity<IKResponse<PaymentDTO>> updatePayments(@RequestBody UpdatePaymentsDTO dto) {
		try {

			List<Payment> paymentList = updatePayment.execute(converter.parseRequestToDomainList(dto.getPayments()), new WorkOrderId(dto.getWorkOrderId(), dto.getBudgetId()));
